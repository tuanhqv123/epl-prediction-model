...
print("FINAL MODEL - CORRECT (NO DATA LEAKAGE)")
print("=" * 60)
...
print(f"\nRESULTS (CORRECT - NO DATA LEAKAGE):")
print("-" * 60)
...
print("-" * 60)
print(f"Original baseline (no xG):  Loss=0.9362, Acc=56.7%")
print(f"Current model (correct):    Loss={test_loss:.4f}, Acc={acc*100:.1f}%")
