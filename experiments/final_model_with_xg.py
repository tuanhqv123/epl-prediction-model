...
print(f"With xG ELO only:  Loss=0.9333, Acc=56.8%")
print(f"With xG + xGA ELO: Loss={test_loss:.4f}, Acc={acc*100:.1f}%")
...
with open("epl_model_with_xg.pkl", "wb") as f:
    pickle.dump({
        "model": model,
        "scaler": scaler,
