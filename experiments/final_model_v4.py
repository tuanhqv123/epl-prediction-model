"""
FINAL MODEL V4 - Added home_away_form feature
Loss: 0.9307 (improved from 0.9310)
"""
import sys
sys.path.insert(0, '.')
import numpy as np
...
def create_features(df, defaults):
    ...
    for _, m in df.iterrows():
        ...
        features.append({
            ...
            "home_away_form": h_home_wins - a_away_wins,  # NEW
        })
...
print("FINAL MODEL V4 - with home_away_form")
print("=" * 60)
