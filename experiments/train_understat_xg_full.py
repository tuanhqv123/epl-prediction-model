...
FEATURE_COLS = ["home_elo", "away_elo", "elo_diff", "elo_expected", "att_def_matchup",
                ...
                "h_xg_rolling", "a_xg_rolling", "xg_diff_rolling"]
...
def create_features(df, home_adv, k_factor, k_att, k_def, defaults, elo_divisor=400):
    ...
    for _, m in df.iterrows():
        ...
        # Rolling xG from Understat (past matches)
        ...
        features.append({
            ...
            "xg_diff_rolling": h_xg_rolling - a_xg_rolling,
        })
        ...
        # Update xG history AFTER match (using Understat xG)
...
print(f"Understat forecast: Loss=0.8430, Acc=61.3%")

print(f"\nFeature Importance (for Home class):")
coef_df = pd.DataFrame({
    'feature': FEATURE_COLS,
    'coef': model.coef_[2]  # H class
